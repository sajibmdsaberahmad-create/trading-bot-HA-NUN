...
export LOCK_STALE_RELEASE_SEC="${LOCK_STALE_RELEASE_SEC:-240}"
...
export WAR_CAPITAL_USD="${WAR_CAPITAL_USD:-3500}"
...
export WAR_PAPER_MAX_ROUND_TRIPS_PER_DAY="${WAR_PAPER_MAX_ROUND_TRIPS_PER_DAY:-5}"
...
export WAR_PAPER_LAB_MAX_ROUND_TRIPS_PER_DAY="${WAR_PAPER_LAB_MAX_ROUND_TRIPS_PER_DAY:-4}"
...
export SNIPER_TICK_STREAM_COUNT="${SNIPER_TICK_STREAM_COUNT:-4}"
# Dual lock pool — mega-cap kill-shot lane + lottery lane
export SCAN_LOCK_DUAL_POOL="${SCAN_LOCK_DUAL_POOL:-true}"
export SCAN_LOCK_MEGA_CAP_SLOTS="${SCAN_LOCK_MEGA_CAP_SLOTS:-3}"
export SCAN_MEGA_CAP_MIN_PRICE="${SCAN_MEGA_CAP_MIN_PRICE:-20}"
export SCAN_TIER_PENNY_MAX_PRICE="${SCAN_TIER_PENNY_MAX_PRICE:-5}"
export SCAN_TIER_MID_MAX_PRICE="${SCAN_TIER_MID_MAX_PRICE:-50}"
