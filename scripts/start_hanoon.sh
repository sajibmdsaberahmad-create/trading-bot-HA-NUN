...
export WAR_MAX_ENTRIES_PER_HOUR="${WAR_MAX_ENTRIES_PER_HOUR:-0}"
export WAR_PAPER_MAX_ENTRIES_PER_HOUR="${WAR_PAPER_MAX_ENTRIES_PER_HOUR:-0}"
export MAX_ENTRIES_PER_HOUR="${MAX_ENTRIES_PER_HOUR:-0}"
...
# ═══ PPO-led coevolution profile (green mandatory; overlapping gates OFF) ═══
# Chain: PPO reflex → execute when green passes → Halim async monitor/blend → API teacher on hard cases.
# 0 = unlimited hourly entries (learning via actions, not clocks).
export MAX_ENTRIES_PER_HOUR="${MAX_ENTRIES_PER_HOUR:-0}"
export WAR_MAX_ENTRIES_PER_HOUR="${WAR_MAX_ENTRIES_PER_HOUR:-0}"
export WAR_PAPER_MAX_ENTRIES_PER_HOUR="${WAR_PAPER_MAX_ENTRIES_PER_HOUR:-0}"
export PPO_LEAD_WHILE_COUNCIL_PENDING="${PPO_LEAD_WHILE_COUNCIL_PENDING:-true}"
export SMART_STACK_STRICT_PROFIT_PROB="${SMART_STACK_STRICT_PROFIT_PROB:-false}"
...
export CAPITAL_MIN_CONFIDENCE="${CAPITAL_MIN_CONFIDENCE:-0.58}"
export MIN_PROFIT_PROBABILITY="${MIN_PROFIT_PROBABILITY:-0.58}"
export CONFIDENCE_THRESHOLD="${CONFIDENCE_THRESHOLD:-0.58}"
# PPO wheel: war sizes only; Halim fully async; deploy tiers; learn firewall
...
export COUNCIL_VISION_SWAP_TEXT_MODEL=false
