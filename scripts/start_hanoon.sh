...
export IB_SCANNER_WARMUP_SEC="${IB_SCANNER_WARMUP_SEC:-3}"
...
echo "✅ Learning posture: loss_streak=on incremental_train=off runtime_observer=on | paper_md=5s-bars | live_tick=${USE_TICK_STREAM}"
