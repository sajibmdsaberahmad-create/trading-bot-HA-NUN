...
# War account — paper trains as $1k cash; live uses WAR_LIVE_OPERATING_CAPITAL only
...
export WAR_BULLETS="${WAR_BULLETS:-5}"
export WAR_MAX_ROUND_TRIPS_PER_DAY="${WAR_MAX_ROUND_TRIPS_PER_DAY:-3}"
export WAR_MAX_ENTRIES_PER_HOUR="${WAR_MAX_ENTRIES_PER_HOUR:-2}"
export MAX_ENTRIES_PER_HOUR="${MAX_ENTRIES_PER_HOUR:-2}"
export WAR_LAB_ENABLED="${WAR_LAB_ENABLED:-true}"
export WAR_LAB_CAPITAL_USD="${WAR_LAB_CAPITAL_USD:-2500}"
...
export WAR_SNIPER_CONF_BUMP="${WAR_SNIPER_CONF_BUMP:-0.06}"
