...
export HALIM_ENTRY_LM_TIMEOUT_SEC=35            # Reduced from 90s — fast timeout on mem pressure
export HALIM_ENTRY_MAX_TOKENS=32                # Small output for mem pressure
export HALIM_ENTRY_TEMPERATURE=0.04
export HALIM_INFERENCE_TIMEOUT_SEC=35           # Reduced from 90s — mlx_complete aborts at 30s
export MLX_GENERATE_TIMEOUT_SEC=30              # Hard abort on MLX generate if mem pressure hits
