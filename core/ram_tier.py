...
_TIER_ENV_KEYS: Dict[str, str] = {
    ...
    "COUNCIL_META_OPTIMIZER_ENABLED": "COUNCIL_META_OPTIMIZER_ENABLED",
    ...
    "ENTRY_COUNCIL_WAIT_SEC": "ENTRY_COUNCIL_WAIT_SEC",
...
TIER_PROFILES: Dict[str, Dict[str, Any]] = {
    "compact": {
        ...
        "COUNCIL_META_OPTIMIZER_ENABLED": False,
        ...
        "COUNCIL_NANNY_HOT_RING_SEC": 20.0,
        "COUNCIL_NANNY_RESERVE_PCT": 0.25,
        "ENTRY_COUNCIL_WAIT_SEC": 8.0,
    ...
    "standard": {
        ...
        "COUNCIL_TIMEOUT_SEC": 12,
        "COUNCIL_META_OPTIMIZER_ENABLED": True,
