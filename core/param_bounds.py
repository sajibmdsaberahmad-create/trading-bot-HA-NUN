...
LIVE_PARAM_BOUNDS: Dict[str, Tuple[Union[int, float], Union[int, float]]] = {
    ...
    "MAX_FAKEOUT_RISK_ENTER": (0.35, 0.85),
    "ENTRY_QUALITY_HARDNESS": (0.0, 1.0),
    "ENTRY_QUALITY_BLEND_WEIGHT": (0.0, 0.80),
    "LIKELY_FAKEOUT_BLOCK_LEVEL": (0.0, 1.0),
    "EQ_WEIGHT_PROFIT_RUN": (0.05, 0.40),
    "EQ_WEIGHT_SPIKE_LIK": (0.05, 0.35),
    "EQ_WEIGHT_SCAN": (0.05, 0.35),
    "EQ_WEIGHT_PPO": (0.05, 0.30),
    "EQ_WEIGHT_VOL_SPIKE": (0.05, 0.30),
    "EQ_WEIGHT_MOM": (0.03, 0.25),
    "EQ_PENALTY_FADE": (0.10, 0.50),
    "EQ_PENALTY_LOSS": (0.10, 0.45),
    "FAKEOUT_FADE_MIN_FADE": (0.25, 0.60),
    "FAKEOUT_FADE_MIN_SL": (0.20, 0.55),
    "COUNCIL_TIMEOUT_MIN_SCAN_SCORE": (20.0, 75.0),
    "COUNCIL_SCANNER_FAST_MIN_SCORE": (15.0, 85.0),
    "AI_SPIKE_FAST_MIN_SCORE": (10.0, 70.0),
    "AI_SPIKE_FAST_MIN_RATIO": (1.05, 2.0),
