...
# ═════════════════════════════════════════════════════════════════════════════
# ═════════════════════════════════════════════════════════════════════════════
# LEARNING PERSISTENCE — see git_sync_learning.py
# ═════════════════════════════════════════════════════════════════════════════

from core.git_sync_learning import (  # noqa: E402
    LEARNING_ARTIFACTS,
    LEARNING_REQUIRED_CODE,
    _learning_files_flat,
    _force_learning_restore,
    _local_learning_file_ok,
    _hanoon_learning_needs_fetch,
    _repo_patterns_need_pull,
    _model_needs_release_download,
    is_learning_current,
    _should_restore_file,
    pull_from_secondary_repo,
    restore_hanoon_learning,
    restore_model_from_release,
    restore_all_learning,
